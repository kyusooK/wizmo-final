<template>
    <v-card style="width:450px; height:100%;" outlined>
        ...
        <v-card-text>
            ...
            <String label="수주상태" v-model="value.status" :editMode="editMode" :inputUI="''"/>
            <List&lt;SalesItems&gt; offline label="SalesItems" v-model="value.salesItems" :editMode="editMode" @change="change"/>
            <SalesItemsManager offline label="SalesItems" v-model="value.salesItems" :editMode="editMode" @change="change"/>
